...
violation contains v if { v := icu.violation[_] }
violation contains v if { v := iaa.violation[_] }
violation contains v if { v := isu.violation[_] }
violation contains v if { v := ibp.violation[_] }
violation contains v if { v := ico.violation[_] }
violation contains v if { v := icr.violation[_] }
violation contains v if { v := ids.violation[_] }
violation contains v if { v := iov.violation[_] }
violation contains v if { v := ipc.violation[_] }
violation contains v if { v := smc.violation[_] }
