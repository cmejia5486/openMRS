...
# SECM-CAT-IBP-001
violation contains "SECM-CAT-IBP-001" if {
  not compliant_no_high_vulns
}

# SECM-CAT-IBP-002
violation contains "SECM-CAT-IBP-002" if {
  not compliant_not_debuggable
}

# SECM-CAT-IBP-003
violation contains "SECM-CAT-IBP-003" if {
  not compliant_not_debuggable
}

# SECM-CAT-IBP-004
violation contains "SECM-CAT-IBP-004" if {
  not compliant_not_debuggable
}

# SECM-CAT-IBP-005
violation contains "SECM-CAT-IBP-005" if {
  not compliant_no_high_vulns
}

# SECM-CAT-IBP-006
violation contains "SECM-CAT-IBP-006" if {
  not compliant_no_high_vulns
}

# SECM-CAT-IBP-007
violation contains "SECM-CAT-IBP-007" if {
  not compliant_not_debuggable
}

# SECM-CAT-IBP-008
violation contains "SECM-CAT-IBP-008" if {
  not compliant_no_high_vulns
}

# SECM-CAT-IBP-009
violation contains "SECM-CAT-IBP-009" if {
  not compliant_no_raw_sql
}

# SECM-CAT-IBP-010
violation contains "SECM-CAT-IBP-010" if {
  not compliant_no_raw_sql
}

# SECM-CAT-IBP-011
violation contains "SECM-CAT-IBP-011" if {
  not compliant_no_raw_sql
}

# SECM-CAT-IBP-012
violation contains "SECM-CAT-IBP-012" if {
  not compliant_no_high_vulns
}

# SECM-CAT-IBP-013
violation contains "SECM-CAT-IBP-013" if {
  not compliant_not_debuggable
}

# SECM-CAT-IBP-014
violation contains "SECM-CAT-IBP-014" if {
  not compliant_not_debuggable
}

# SECM-CAT-IBP-015
violation contains "SECM-CAT-IBP-015" if {
  not compliant_not_debuggable
}

# SECM-CAT-IBP-016
violation contains "SECM-CAT-IBP-016" if {
  not compliant_no_high_vulns
}

# SECM-CAT-IBP-017
violation contains "SECM-CAT-IBP-017" if {
  not compliant_not_debuggable
}

# SECM-CAT-IBP-018
violation contains "SECM-CAT-IBP-018" if {
  not compliant_no_high_vulns
}

# SECM-CAT-IBP-019
violation contains "SECM-CAT-IBP-019" if {
  not compliant_no_high_vulns
}

# SECM-CAT-IBP-020
violation contains "SECM-CAT-IBP-020" if {
  not compliant_no_high_vulns
}

# SECM-CAT-IBP-021
violation contains "SECM-CAT-IBP-021" if {
  not compliant_no_high_vulns
}

# SECM-CAT-IBP-022
violation contains "SECM-CAT-IBP-022" if {
  not compliant_no_high_vulns
}

# SECM-CAT-IBP-023
violation contains "SECM-CAT-IBP-023" if {
  not compliant_no_raw_sql
}

# SECM-CAT-IBP-024
violation contains "SECM-CAT-IBP-024" if {
  not compliant_not_debuggable
}

# SECM-CAT-IBP-025
violation contains "SECM-CAT-IBP-025" if {
  not compliant_no_external_storage
}

# SECM-CAT-IBP-026
violation contains "SECM-CAT-IBP-026" if {
  not compliant_tls_or_pinning
}

# SECM-CAT-IBP-027
violation contains "SECM-CAT-IBP-027" if {
  not compliant_no_high_vulns
}

# SECM-CAT-IBP-028
violation contains "SECM-CAT-IBP-028" if {
  not compliant_not_debuggable
}

# SECM-CAT-IBP-029
violation contains "SECM-CAT-IBP-029" if {
  not compliant_not_debuggable
}

# SECM-CAT-IBP-030
violation contains "SECM-CAT-IBP-030" if {
  not compliant_no_high_vulns
}

# SECM-CAT-IBP-031
violation contains "SECM-CAT-IBP-031" if {
  not compliant_not_debuggable
}

# SECM-CAT-IBP-032
violation contains "SECM-CAT-IBP-032" if {
  not compliant_not_debuggable
}

# SECM-CAT-IBP-033
violation contains "SECM-CAT-IBP-033" if {
  not compliant_not_debuggable
}

# SECM-CAT-IBP-034
violation contains "SECM-CAT-IBP-034" if {
  not compliant_not_debuggable
}
