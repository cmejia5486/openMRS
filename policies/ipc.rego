...
# SECM-CAT-IPC-001
violation["SECM-CAT-IPC-001"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-002
violation["SECM-CAT-IPC-002"] {
  not compliant_no_hardcoded_secrets
}

# SECM-CAT-IPC-003
violation["SECM-CAT-IPC-003"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-004
violation["SECM-CAT-IPC-004"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-005
violation["SECM-CAT-IPC-005"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-006
violation["SECM-CAT-IPC-006"] {
  not compliant_no_hardcoded_secrets
}

# SECM-CAT-IPC-007
violation["SECM-CAT-IPC-007"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-008
violation["SECM-CAT-IPC-008"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-009
violation["SECM-CAT-IPC-009"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-010
violation["SECM-CAT-IPC-010"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-011
violation["SECM-CAT-IPC-011"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-012
violation["SECM-CAT-IPC-012"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-013
violation["SECM-CAT-IPC-013"] {
  not compliant_no_sensitive_logging
}

# SECM-CAT-IPC-014
violation["SECM-CAT-IPC-014"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-015
violation["SECM-CAT-IPC-015"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-016
violation["SECM-CAT-IPC-016"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-017
violation["SECM-CAT-IPC-017"] {
  not compliant_no_sensitive_logging
}

# SECM-CAT-IPC-018
violation["SECM-CAT-IPC-018"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-019
violation["SECM-CAT-IPC-019"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-020
violation["SECM-CAT-IPC-020"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-021
violation["SECM-CAT-IPC-021"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-022
violation["SECM-CAT-IPC-022"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-023
violation["SECM-CAT-IPC-023"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-024
violation["SECM-CAT-IPC-024"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-025
violation["SECM-CAT-IPC-025"] {
  not compliant_no_hardcoded_secrets
}

# SECM-CAT-IPC-026
violation["SECM-CAT-IPC-026"] {
  not compliant_not_debuggable
}

# SECM-CAT-IPC-027
violation["SECM-CAT-IPC-027"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-028
violation["SECM-CAT-IPC-028"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-029
violation["SECM-CAT-IPC-029"] {
  not compliant_no_high_vulns
}

# SECM-CAT-IPC-030
violation["SECM-CAT-IPC-030"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-031
violation["SECM-CAT-IPC-031"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-032
violation["SECM-CAT-IPC-032"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-033
violation["SECM-CAT-IPC-033"] {
  not compliant_no_hardcoded_secrets
}

# SECM-CAT-IPC-034
violation["SECM-CAT-IPC-034"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-035
violation["SECM-CAT-IPC-035"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-036
violation["SECM-CAT-IPC-036"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-037
violation["SECM-CAT-IPC-037"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-038
violation["SECM-CAT-IPC-038"] {
  not compliant_no_hardcoded_secrets
}

# SECM-CAT-IPC-039
violation["SECM-CAT-IPC-039"] {
  not compliant_no_hardcoded_secrets
}

# SECM-CAT-IPC-040
violation["SECM-CAT-IPC-040"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-041
violation["SECM-CAT-IPC-041"] {
  not compliant_no_exported_components
}

# SECM-CAT-IPC-042
violation["SECM-CAT-IPC-042"] {
  not compliant_no_exported_components
}
