...
def build(args: argparse.Namespace) -> None:
    ...
    _write_rows(wb, "run_results", run_results, ["run_id", "is_comparable", "num_requirements", "num_yes", "num_no", "num_na", "compliance_matrix_hash", "json_valid_rate", "schema_valid_rate", "completion_rate", "traceability_ok_rate", "fallback_rate", "retry_rate", "prompt_success_rate"])
    if matrix_rows:
